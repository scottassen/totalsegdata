function GeoFilter3D_NRRD_custom()
clc ; close all
...
%%
% Fix filename to baseline scan: ct328.nrrd
baseline = 'ct249';
i_file = strcat(baseline, '.nrrd');
...
for i = 5:10:95
    ...
    o_file = strcat(baseline, 'geo', num2str(i), '.nrrd');
    disp(o_file)
